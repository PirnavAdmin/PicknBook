...
export default function HotelUsedCouponList() {
  ...
  const [usedCoupons, setUsedCoupons] = useAdminList("hotel-used-coupons-v2", []);
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div style={{ ...styles.titleSection, paddingTop: '16px', paddingBottom: '16px' }}>
          <h1 style={{ fontSize: '20px', fontWeight: 600, color: '#111827', margin: 0, lineHeight: '28px' }}>
            <span style={{ color: '#A51C49' }}>B2C Hotel</span> Used Coupon List
          </h1>
        </div>
        <div style={styles.actionGroup}>
          <button 
            ...
            style={{
              ...
              alignItems: 'center',
              gap: '6px',
              boxShadow: '0 2px 4px rgba(165, 28, 73, 0.15)'
            }}
            className="btn-hover"
          >
            <Tag size={14} /> Coupon List
          </button>
          <button 
          ...
          <button 
            ...
            className="btn-hover"
          >
            <FilterIcon size={14} /> {isFilterOpen ? 'Hide Filter' : 'Filter'}
          </button>
        </div>
      </div>
      ...
      <div style={styles.statsGrid}>
        ...
        <div style={styles.statCard} className="stat-card-hover">
          <div style={styles.statInfo}>
            <span style={{ fontSize: '11px', fontWeight: '600', color: '#D81B60', textTransform: 'uppercase', letterSpacing: '0.02em' }}>Total Coupons</span>
            <span style={{ fontSize: '18px', fontWeight: '600', color: '#111827', margin: '2px 0' }}>{stats.totalCount + 122}</span>
            <span style={{ fontSize: '9px', color: '#64748B' }}>All hotel coupons</span>
          </div>
        ...
        <div style={styles.statCard} className="stat-card-hover">
          <div style={styles.statInfo}>
            <span style={{ fontSize: '11px', fontWeight: '600', color: '#2563EB', textTransform: 'uppercase', letterSpacing: '0.02em' }}>Active Coupons</span>
            <span style={{ fontSize: '18px', fontWeight: '600', color: '#111827', margin: '2px 0' }}>{stats.activeCount + 75}</span>
            <span style={{ fontSize: '9px', color: '#64748B' }}>Currently active</span>
          </div>
        ...
        <div style={styles.statCard} className="stat-card-hover">
          <div style={styles.statInfo}>
            <span style={{ fontSize: '11px', fontWeight: '600', color: '#EA580C', textTransform: 'uppercase', letterSpacing: '0.02em' }}>Expired Coupons</span>
            <span style={{ fontSize: '18px', fontWeight: '600', color: '#111827', margin: '2px 0' }}>{stats.expiredCount + 29}</span>
            <span style={{ fontSize: '9px', color: '#64748B' }}>Already expired</span>
          </div>
        ...
        <div style={styles.statCard} className="stat-card-hover">
          <div style={styles.statInfo}>
            <span style={{ fontSize: '11px', fontWeight: '600', color: '#8B5CF6', textTransform: 'uppercase', letterSpacing: '0.02em' }}>Total Redemptions</span>
            <span style={{ fontSize: '18px', fontWeight: '600', color: '#111827', margin: '2px 0' }}>{1253 + stats.totalCount}</span>
            <span style={{ fontSize: '9px', color: '#64748B' }}>Total times used</span>
          </div>
        ...
        <div style={styles.statCard} className="stat-card-hover">
          <div style={styles.statInfo}>
            <span style={{ fontSize: '11px', fontWeight: '600', color: '#10B981', textTransform: 'uppercase', letterSpacing: '0.02em' }}>Total Savings</span>
            <span style={{ fontSize: '18px', fontWeight: '600', color: '#111827', margin: '2px 0' }}>₹{(245480 + stats.totalSaved).toLocaleString()}</span>
            <span style={{ fontSize: '9px', color: '#64748B' }}>Total amount saved</span>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '16px', borderTop: '1px solid #E2E8F0', paddingTop: '16px' }}>
            <button 
              ...
              style={{
                ...
                alignItems: 'center',
                gap: '6px',
                boxShadow: '0 2px 4px rgba(100, 116, 139, 0.15)'
              }}
              className="btn-hover"
            >
            ...
            <table style={styles.table}>
              ...
              <tbody>
                {paginatedRecords.length === 0 ? (
                  <tr>
                    <td colSpan={10} style={{ padding: '24px', textAlign: 'center', color: colors.textSecondary }}>
