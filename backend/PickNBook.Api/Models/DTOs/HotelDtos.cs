...
namespace PickNBook.Api.Models.DTOs
{
    ...
    public class AdminHotelCancellationRequestDto
    {
        ...
        public AdminHotelCancellationDetailsDto Details { get; set; } = new();
    }

    public class AdminHotelCancellationDetailsDto
    {
    ...
    public class HotelCancellationRequestUpdateDto
    {
        public string CancellationStatus { get; set; } = "Pending";
        public string CustomerRefundStatus { get; set; } = "Pending";
        public string AdminRefundStatus { get; set; } = "Pending";
