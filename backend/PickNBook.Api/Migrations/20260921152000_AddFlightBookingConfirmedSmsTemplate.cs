...
{
    /// <inheritdoc />
    public partial class AddFlightBookingConfirmedSmsTemplate : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                WHERE template_key IN ('FLIGHT_BOOKING_CONFIRMED', 'FLIGHT_BOOKING_CONFIRMED_SMS') AND channel = 'SMS';
            ");
        }
    }
}
