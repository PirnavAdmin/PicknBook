...
namespace PickNBook.Api.Migrations
{
    ...
    [Migration("20260918093312_AddInAppNotificationTables")]
    partial class AddInAppNotificationTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PickNBook.Api.Models.BusCity", b =>
                {
                    ...
                    b.ToTable("bus_cities", (string)null);
                });
            ...
            modelBuilder.Entity("PickNBook.Api.Models.BusCoupon", b =>
                {
                    ...
                    b.HasIndex("PromotionCategory");

                    b.ToTable("bus_coupons", (string)null);
                });

            modelBuilder.Entity("PickNBook.Api.Models.BusCouponCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BusCouponId");

                    b.HasIndex("ConditionType");

                    b.ToTable("bus_coupon_conditions", (string)null);
                });
            ...
            modelBuilder.Entity("PickNBook.Api.Models.BusReservation", b =>
                {
                    ...
                    b.Property<decimal>("GatewayPaidAmount")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.Property<long?>("ProviderCancelId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("SupplierCancelId")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.BusReservationPassenger", b =>
                {
                    ...
                    b.Property<decimal?>("OfferedFareInr")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal?>("PublishedFareInr")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Entities.BookingCancellation", b =>
                {
                    ...
                    b.Property<decimal>("GatewayRefundAmount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("SeatNamesJson")
                        .HasColumnType("longtext");
                    ...
                    b.Property<decimal>("WalletRefundAmount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Entities.FlightAirline", b =>
                {
                    b.Property<string>("AirlineCode")
                        .HasMaxLength(2)
                    ...
                    b.ToTable("flight_airlines", (string)null);
                });

            modelBuilder.Entity("PickNBook.Api.Models.Entities.FlightAirport", b =>
                {
                    ...
                    b.ToTable("flight_airports", (string)null);
                });
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Entities.InAppNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Entities.NotificationRecipient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Entities.SecurityUserRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Entities.UserPasskey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Entities.WalletTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RefCode", "ReferenceType");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.FlightCouponCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FlightCouponId");

                    b.ToTable("flight_coupon_conditions", (string)null);
                });
            ...
            modelBuilder.Entity("PickNBook.Api.Models.HotelCity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HotelCount");

                    b.HasIndex("IsActive");

                    b.ToTable("hotel_cities", (string)null);
                });
            ...
            modelBuilder.Entity("PickNBook.Api.Models.HotelCouponCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HotelCouponId");

                    b.ToTable("hotel_coupon_conditions", (string)null);
                });
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Payments.Payment", b =>
                {
                    ...
                    b.Property<string>("GatewayPaymentMethod")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
                    ...
                    b.Property<string>("WalletReservationStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)")
                    ...
                    b.HasIndex("WalletReservationStatus");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.TestimonialSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("AllowCustomerImage")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("AllowRating")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("AllowUserSubmission")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<string>("DisplayOrderMode")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("PickNBook.Api.Models.BusCouponCondition", b =>
                {
                    b.HasOne("PickNBook.Api.Models.BusCoupon", "Coupon")
                        .WithMany("Conditions")
            ...
            modelBuilder.Entity("PickNBook.Api.Models.Entities.NotificationRecipient", b =>
                {
                    b.HasOne("PickNBook.Api.Models.Entities.InAppNotification", "Notification")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("PickNBook.Api.Models.FlightCouponCondition", b =>
                {
                    b.HasOne("PickNBook.Api.Models.FlightCoupon", "Coupon")
                        .WithMany("Conditions")
                        .HasForeignKey("FlightCouponId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PickNBook.Api.Models.HotelCouponCondition", b =>
                {
                    b.HasOne("PickNBook.Api.Models.HotelCoupon", "Coupon")
                        .WithMany("Conditions")
                        .HasForeignKey("HotelCouponId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
