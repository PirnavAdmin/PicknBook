...
{
    /// <inheritdoc />
    public partial class AddHotelBookingConfirmedSmsTemplate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                INSERT INTO notification_templates (
                    ...
                    'en', 
                    'PICNBK', 
                    'PickNBook: Hotel booking confirmed. Ref ${var1}. Hotel: ${var2}. Check-in: ${var3}. Check-out: ${var4}.', 
                    '1777178962451868362', 
                    'HOTEL_BOOKING_CONFIRMED', 
                    1, 
                    NOW(), 
